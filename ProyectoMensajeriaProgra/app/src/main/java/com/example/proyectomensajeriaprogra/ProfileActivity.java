...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ChatRequestRef = FirebaseDatabase.getInstance().getReference().child("Chat Requests");//Verificar esto Puede que sea el error
...
//VERIFICAR ESTO PUEDA QUE INTERVENGA EN LOS CHATS PRIVADOS
